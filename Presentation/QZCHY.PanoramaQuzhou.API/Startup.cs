...
using QZCHY.PanoramaQuzhou.API;
using QZCHY.PanoramaQuzhou.Web.Framework.Filters;
...
namespace QZCHY.PanoramaQuzhou.Api
{
    public class Startup
    {
        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            //自定义配置
            config.Services.Add(typeof(ModelValidatorProvider), new FluentValidationModelValidatorProvider(new PanoramaQuzhouValidatorFactory()));
