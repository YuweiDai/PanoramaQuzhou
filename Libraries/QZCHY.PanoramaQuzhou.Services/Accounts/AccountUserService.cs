...
namespace QZCHY.PanoramaQuzhou.Services.Accounts
{
    ...
    public class AccountUserService : IAccountUserService
    {
        ...
        public void DeleteAccountUser(AccountUser accountUser)
        {
            ...
            //    throw new CSCZJException(string.Format("System accountUser account ({0}) could not be deleted", accountUser.SystemName));
        ...
        public virtual AccountUser GetAccountUserByNickname(string nickName)
        {
            ...
            var query = from c in _accountUserRepository.Table
                        orderby c.Id
                        where c.NickName == nickName && !c.Deleted
                        select c;
        ...
        public IPagedList<AccountUser> GetAllAccountUsers(string search = "", int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false, params PropertySortCondition[] sortConditions)
        {
            ...
            {
                query = query.Where(e => e.NickName.Contains(search));
            }
        ...
        public bool NameUniqueCheck(string accountUserName, int accountUserId = 0)
        {
            ...
            {
                var accountUser = query.Where(c => c.NickName == accountUserName).FirstOrDefault();
        ...
        //        throw new PanoramaQuzhouException("System role could not be deleted");
