...
namespace QZCHY.PanoramaQuzhou.Services.Security
{
    /// <summary>
    ...
    public partial interface IPermissionService
    {
        ...
        /// <returns>true - authorized; otherwise, false</returns>
        bool Authorize(PermissionRecord permission, AccountUser property);
        ...
        /// <param name="property">AccountUser</param>
        /// <returns>true - authorized; otherwise, false</returns>
        bool Authorize(string permissionRecordSystemName, AccountUser property);
    }
}
