...
namespace QZCHY.PanoramaQuzhou.Services.Helpers
{
    /// <summary>
    /// User agent helper
    /// </summary>
    ...
    {
        private readonly PanoramaQuzhouConfig _config;
        ...
        public UserAgentHelper(PanoramaQuzhouConfig config, IWebHelper webHelper, HttpContextBase httpContext)
        {
            this._config = config;
