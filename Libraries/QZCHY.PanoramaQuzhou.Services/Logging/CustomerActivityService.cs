...
namespace QZCHY.Services.Logging
{
    ...
    public class AccountUserActivityService : IAccountUserActivityService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string ACTIVITYTYPE_ALL_KEY = "QZCHY.activitytype.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ACTIVITYTYPE_PATTERN_KEY = "QZCHY.activitytype.";
        ...
        /// <returns>Activity log item</returns>
        public virtual ActivityLog InsertActivity(string systemKeyword, 
            string comment, AccountUser customer, params object[] commentParams)
        {
            if (customer == null)
                return null;
