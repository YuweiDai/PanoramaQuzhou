...
namespace QZCHY.PanoramaQuzhou.Services.Logging
{
    /// <summary>
    /// AccountUser activity service
    /// </summary>
    public class AccountUserActivityService : IAccountUserActivityService
    {
        #region Constants
        ...
        /// Key for caching
        /// </summary>
        private const string ACTIVITYTYPE_ALL_KEY = "QZCHY.PanoramaQuzhou.activitytype.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ACTIVITYTYPE_PATTERN_KEY = "QZCHY.PanoramaQuzhou.activitytype.";
        ...
        public AccountUserActivityService(ICacheManager cacheManager,
        ...
        {
            return InsertActivity(systemKeyword, comment, _workContext.CurrentAccountUser, commentParams);
        }
        ...
        /// <returns>Activity log item</returns>
        public virtual ActivityLog InsertActivity(string systemKeyword, 
            string comment, AccountUser property, params object[] commentParams)
        {
            if (property == null)
                return null;
        ...
        /// <param name="customerId">AccountUser identifier; null to load all customers</param>
        /// <param name="activityLogTypeId">Activity log type identifier</param>
            ...
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            if (customerId.HasValue)
                query = query.Where(al => customerId.Value == al.AccountUserId);
