...
namespace QZCHY.PanoramaQuzhou.Core.Configuration
{
    /// <summary>
    /// Represents a QMTechConfig
    /// </summary>
    public partial class QZCHYPanoramaQuzhouConfig : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        {
            var config = new QZCHYPanoramaQuzhouConfig();
