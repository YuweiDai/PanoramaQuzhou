...
namespace QZCHY.PanoramaQuzhou.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        protected virtual bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into QMTechCommerce, 
                ...
                //The issue is described here: http://www.QMTechcommerce.com/boards/t/10969/QMTech-20-plugin.aspx?p=4#51318
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                //as described here http://www.QMTechcommerce.com/boards/t/21356/multi-store-roadmap-lets-discuss-update-done.aspx?p=6#90196
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new PanoramaQuzhouException("QMTechCommerce needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["QMTech.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["QMTech.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["QMTech.IsPOSTBeingDone"] = value;
            }
        }
