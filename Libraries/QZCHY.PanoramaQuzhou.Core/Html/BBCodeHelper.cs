...
using QZCHY.PanoramaQuzhou.Core.Html.CodeFormatter;

namespace QZCHY.PanoramaQuzhou.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.QMTechCommerce.com]my site[/url]
                // becomes: <a href="http://www.QMTechCommerce.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.QMTechCommerce.com[/url]
                // becomes: <a href="http://www.QMTechCommerce.com">http://www.QMTechCommerce.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.QMTechCommerce.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.QMTechCommerce.com/Content/Images/Image.jpg"></img>
